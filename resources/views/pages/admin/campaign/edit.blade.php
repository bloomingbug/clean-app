        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="time" class="form-control @error('event_time') is-invalid @enderror" id="eventTime"
                        name="event_time" value="{{ $campaign->event_time }}" <div id="event_time"
            ...
            <div class="form-group mb-3">
                ...
                <textarea type="text" class="form-control @error('description') is-invalid @enderror" id="description"
                    name="description" value="{{ $campaign->description }}"
            ...
            <div class="form-group mb-3">
                ...
                <div class="d-flex align-items-center justify-content-between flex-nowrap gap-2">
                    <input type="text" class="form-control @error('location') is-invalid @enderror" id="location"
                        name="location" value="{{ $campaign->latitude . ', ' . $campaign->longitude }}"
